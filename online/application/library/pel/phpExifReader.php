            ...
            */
            ...
            switch($Tag){
                ...
                case TAG_FOCALLENGTH:
                    ...
                    $this->ImageInfo['h']["focalLength"] = sprintf("%4.0fmm",(double)$tmp[0]);
                ...
                case TAG_EXPOSURETIME:
                    ...
                    if ($tmp[0] <= 0.5){
                            ...
                            $this->ImageInfo['h']["exposureTime"] .= sprintf("1/%d s",(int)(0.5 + 1/$tmp[0]));
                    } else {
	                    	$this->ImageInfo['h']["exposureTime"] = sprintf("%d/%d s",$tmp[1][0],$tmp[1][1]);
                    }
                    break;
